...
const handleSubmit = (values: SignUpFormValues) => {
  ...
  // 🟩 Evitar sobreescribir el grupo familiar
  if (user?.familyGroup) {
    base.familyGroup = user.familyGroup;
  }
            ...
            <Tooltip title={lockUser ? "Desbloquear usuario" : "Bloquear usuario"}>
              <IconButton
                ...
                sx={{
                  ...
                  p: 1,
                  "&:hover": {
                    bgcolor: lockUser ? "rgba(220,20,60,0.08)" : "rgba(0,128,0,0.08)",
                  },
                }}
              >
            ...
            <Form onChange={() => !hasChanges && setHasChanges(true)}>
              <Grid container spacing={4}>
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  ...
                  {/* Disciplinas */}
                  <FormControl variant="standard" fullWidth sx={{ mt: 1.8}}>
                        ...
                        disciplines.map((item: any) => {
                          ...
                          return (
                            <MenuItem key={item?.id ?? label} value={label}>
                              <Checkbox
                                checked={ensureStringArray(values.disciplines).includes(
                                  label
                                )}
                              />
                ...
                {/* 🟩 Campo Grupo familiar ocupa el ancho completo */}
                {isAdmin && (
              ...
              <Grid container spacing={2} sx={{ mt: 5 }}>
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  <Button
                    ...
                    sx={{
                      backgroundColor:
                        isValid && (dirty || hasChanges) ? "green" : "lightgrey",
                      "&:hover": {
                        backgroundColor:
                          isValid && (dirty || hasChanges)
                            ? "darkgreen"
                            : "lightgrey",
                      },
                    }}
